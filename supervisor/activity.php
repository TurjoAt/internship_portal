					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><center><a href = "edit_activity.php?InternshipID=<?php echo $act_fetch['InternshipID']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" name = "<?php echo $act_fetch['InternshipID']?>" data-toggle = "modal" data-target = "#delete_activity" class = "btn btn-danger InternshipID"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
							</tr>
							<?php
								}
							?>
