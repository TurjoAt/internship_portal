...
<!-------------------SIDEBAR0------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
				...
				<a class = "btn btn-success" href = "super.php"><span class = "glyphicon glyphicon-hand-right"></span> Back</a>
				<br />
				<br />
				<div class = "panel panel-default">
					<div  class = " panel-heading" >	
						...
						<?php
							$q_admin = $conn->query("SELECT * FROM `super` WHERE `super_id` = '$_REQUEST[super_id]'") or die(mysqli_error());
							$f_admin = $q_admin->fetch_array();
						?>
							<form method = "POST" action = "edit_admin_query.php?super_id=<?php echo $f_admin['super_id']?>">	
