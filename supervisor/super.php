...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
				<div class = "alert alert-info">Accounts/Supervisor</div>
				...
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `super`") or die(mysqli_error());
								...
								<tr>
									...
									<td><center><a href = "edit_admin.php?super_id=<?php echo $a_fetch['super_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> </center></td>
								</tr>
								<?php
									}
								?>
