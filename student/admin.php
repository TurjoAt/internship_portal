				...
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `person` WHERE `PersonID` = '$_SESSION[PersonID]'") or die(mysqli_error());
								...
								<tr>
									...
									<td><?php echo $a_fetch['Address']?></td>
									<td><center><a href = "edit_admin.php?PersonID=<?php echo $a_fetch['PersonID']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> </center></td>
								</tr>
								<?php
									}
								?>
