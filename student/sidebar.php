<div id = "sidebar">
	<ul id = "menu" class = "nav menu">
		<li>
			<a>
				<?php 
					...
					$q_admin_side = $conn->query("SELECT * FROM `person` WHERE `PersonID` = '$_SESSION[PersonID]'") or die(mysqli_error());
		...
		<li><a href = ""><i class = "glyphicon glyphicon-user"></i> Accounts</a>
			<ul>
				<li><a href = "admin.php"><i class = "glyphicon glyphicon-user"></i> Student</a></li>
               <!-- <li><a href = "students_details.php"><i class = "glyphicon glyphicon-user"></i> students_Acc</a></li>-->
				
			</ul>
		</li>
		<li><a href = "company.php"><i class = "glyphicon glyphicon-calendar"></i>Apply For Internship</a></li>
