		...
		<div id = "sidecontent" class = "well pull-right">
				...
				<div class = "panel panel-default">
					<div  class = " panel-heading" >	
						...
						<?php
							$q_admin = $conn->query("SELECT * FROM `person` WHERE `PersonID` = '$_REQUEST[PersonID]'") or die(mysqli_error());
							$f_admin = $q_admin->fetch_array();
						?>
							<form method = "POST" action = "edit_admin_query.php?PersonID=<?php echo $f_admin['PersonID']?>">	
								...
								<div class = "form-group">
									...
									<input type = "text" value = "<?php echo $f_admin['password']?>" class = "form-control"  name = "password"/>
								</div>
								<div class = "form-group">
									<label>Email</label>
									<input type = "text" value = "<?php echo $f_admin['Email']?>" class = "form-control"  name = "Email"/>
								</div>
								<div class = "form-group">
									<label>Address</label>
									<input type = "text" value = "<?php echo $f_admin['Address']?>" class = "form-control"  name = "Address"/>
								</div>
								<div class = "form-group">
