...
<input type="radio" name="Paid" value="<?php echo $f_activity['Paid']?>" <?php if(isset($_POST['paid']) && $_POST['paid']=="False") { ?>checked<?php  } ?> required > False
							...
							<div class = "form-group">
								...
								<input type ="number" class ="form-control" value="<?php echo $f_activity['HourlyRate']?>" name="Hourlyrate" required/>
							</div>
							<div class = "form-group">
								<label>Stipend</label>
							...
							<div class = "form-group">
								...
								<input type = "date" style = "width:41%;" value="<?php echo $f_activity['StartDate']?>" class = "form-control"  name = "StartDate" required/>
								</div>
							<div class = "form-group">
								<label>End Date</label>
								<input type = "date" style = "width:41%;" value="<?php echo $f_activity['EndDate']?>" class = "form-control"  name = "EndDate" required = "required"/>
							</div>
							<div class = "form-group">
					...
					<input type = "number" class = "form-control" value="<?php echo $f_activity['HoursPerWeek']?>" name = "HoursPerWeek" required = "required"/>
							...
							<div class = "form-group">
								...
								<textarea type = "text" class = "form-control" name = "Description" required = "required"/><?php echo $f_activity['Description']?></textarea> 
							</div>
							<br />
							<div class = "form-group">
