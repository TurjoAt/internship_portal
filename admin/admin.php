						...
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><center><a href = "edit_admin.php?admin_id=<?php echo $a_fetch['admin_id']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> 
										<a href = "#" name = "<?php echo $a_fetch['admin_id']?>" data-toggle = "modal" data-target = "#delete_admin" class = "btn btn-danger admin_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
								</tr>
								<?php
									}
								?>
