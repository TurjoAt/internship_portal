<div id = "sidebar">
	<ul id = "menu" class = "nav menu">
		...
		<li><a href = "company.php"><i class = "glyphicon glyphicon-calendar"></i>Add Company</a></li>
        <li><a href = "super.php"><i class = "glyphicon glyphicon-calendar"></i>Add Supervisor</a></li>
