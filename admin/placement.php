				...
				<div  class = " panel-heading">	
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<?php
							$act_query = $conn->query("SELECT * FROM Placements p JOIN student s on p.StudentID=s.PersonID JOIN internship i on p.InternshipID=i.InternshipID JOIN super su on p.SupervisorID=su.SupervisorID") or die(mysqli_error());
							...
							<tr>
								...
								<td><?php echo $act_fetch['Status']?></td>
								
								
								
								<td><center><a href = "edit_placement.php?pid=<?php echo $act_fetch['pid']?>" class = "btn btn-warning"><span class=  "glyphicon glyphicon-edit"></span> Update</a> </center></td>
							</tr>
							<?php
								}
							?>
